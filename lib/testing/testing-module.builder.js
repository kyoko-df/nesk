...
const instance_loader_1 = require("@neskjs/core/injector/instance-loader");
const container_1 = require("@neskjs/core/injector/container");
const common_1 = require("@neskjs/common");
const scanner_1 = require("@neskjs/core/scanner");
const testing_module_1 = require("./testing-module");
class TestingModuleBuilder {
    constructor(metadataScanner, metadata) {
        this.container = new container_1.NeskContainer();
