...
class KoaRouterExplorer {
    constructor(metadataScanner, routerProxy, koaAdapter, exceptionsFilter, config, container) {
    ...
    explore(instance, metatype, module) {
        const router = this.koaAdapter.createRouter();
...
exports.KoaRouterExplorer = KoaRouterExplorer;
