...
import { ParamData, PipeTransform, RequestMethod } from '@neskjs/common';
...
export declare class RouterExecutionContext {
    ...
    create(instance: Controller, callback: (...args) => any, methodName: string, module: string, requestMethod: RequestMethod): (ctx: any, next: any) => Promise<void>;
    ...
    createGuardsFn(guards: any[], instance: Controller, callback: (...args) => any): (context: any) => Promise<void>;
    createPipesFn(pipes: any[], paramsOptions: (ParamProperties & {
        metatype?: any;
    })[]): (args: any, ctx: any, next: any) => Promise<void>;
    createHandleResponseFn(callback: any, isResponseHandled: boolean, httpStatusCode: number): (result: any, ctx: any) => Promise<any>;
}
