...
exports.InvalidModuleMessage = (scope) => `Nesk can't create the module instance. The frequent reason of this exception is the circular dependency between modules. Use forwardRef() to avoid it (read more https://docs.nestjs.com/advanced/circular-dependency). Scope [${scope}]`;
...
exports.MICROSERVICES_PACKAGE_NOT_FOUND_EXCEPTION = `Unable to load @neskjs/microservices packages (please, make sure whether it's installed already).`;
