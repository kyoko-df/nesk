...
const constants_1 = require("@neskjs/core/constants");
...
const nesk_application_context_1 = require("@neskjs/core/nesk-application-context");
...
class NeskMicroservice extends nesk_application_context_1.NeskApplicationContext {
    constructor(container, config = {}, applicationConfig) {
        super(container, [], null);
        this.applicationConfig = applicationConfig;
        this.logger = new logger_service_1.Logger(NeskMicroservice.name, true);
...
exports.NeskMicroservice = NeskMicroservice;
